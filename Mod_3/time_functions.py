import time
from functions import constant, linear, quadratic
...
t_tup = time_function(search, tuple(i for i in range(10000)))
...
t_tup2 = time_function(search, tuple(i for i in range(20000)))
...
t_tup3 = time_function(search, tuple(i for i in range(40000)))
...
t_tup4 = time_function(search, tuple(i for i in range(60000)))
...
t_tup5 = time_function(search, tuple(i for i in range(80000)))
...
print("----------------------------------------------------------")   
print("10000    {:.7f}    {:.7f}   {:.7f}   {:.7f}".format(t_list * 1000, t_tup * 1000, t_string * 1000, t_set * 1000))
print("20000    {:.7f}    {:.7f}   {:.7f}   {:.7f}".format(t_list2 * 1000, t_tup2 * 1000, t_string2 * 1000, t_set2 * 1000)) 
print("40000    {:.7f}    {:.7f}   {:.7f}   {:.7f}".format(t_list3 * 1000, t_tup3 * 1000, t_string3 * 1000, t_set3 * 1000)) 
print("60000    {:.7f}    {:.7f}   {:.7f}   {:.7f}".format(t_list4 * 1000, t_tup4 * 1000, t_string4 * 1000, t_set4 * 1000)) 
print("80000    {:.7f}    {:.7f}   {:.7f}   {:.7f}".format(t_list5 * 1000, t_tup5 * 1000, t_string5 * 1000, t_set5 * 1000))  
print("----------------------------------------------------------")   