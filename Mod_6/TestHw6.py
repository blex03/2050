...
class TestCocktailSort(unittest.TestCase):
   def test_Sorted(self): 
      L = [1, 2, 3, 4, 5, 6]
      self.assertEqual(cocktail_sort(L), [1, 2, 3, 4, 5, 6])
   ...
   def test_ArbitrarySize(self): 
      ...
      self.assertEqual(cocktail_sort(L1), [1, 2])
      self.assertEqual(cocktail_sort(L2), [1, 2, 3])
      self.assertEqual(cocktail_sort(L3), [1, 2, 3, 4])

class TestOptInsertionSort(unittest.TestCase):
   def test_Sorted(self): 
      L = [1, 2, 3, 4, 5, 6]
      self.assertEqual(opt_insertion_sort(L), [1, 2, 3, 4, 5, 6])
   ...
   def test_ArbitrarySize(self): 
      ...
      self.assertEqual(opt_insertion_sort(L1), [1, 2, 3])
      self.assertEqual(opt_insertion_sort(L2), [1, 2, 3, 4])
      self.assertEqual(opt_insertion_sort(L3), [1, 2, 3, 4, 5])
